<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-refresh" @click="fetchData">
        刷新
      </el-button>
      <el-button
        class="filter-item"
    ...
    >
      ...
      <el-table-column align="center" label="JOB-ID" width="80">
      ...
      <el-table-column label="执行结果" align="center" width="80">
